...
wget https://github.com/thichcode/rust_teams/releases/download/v0.9.60/rust-teams_0.9.60_amd64.deb

# Install
sudo dpkg -i rust-teams_0.9.60_amd64.deb
...
```bash
wget https://github.com/thichcode/rust_teams/releases/download/v0.9.60/rust_teams-linux-x64.tar.gz
